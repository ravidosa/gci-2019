...
var Game = {
	...
	draw: function () {
		...
		const image = document.getElementById('soccer');
		if (screenNumber == 1) {
			context.drawImage(image, this.ball.x, this.ball.y, this.ball.width, this.ball.height)
		} else {
			context.drawImage(image, ballX, ballY, this.ball.width, this.ball.height)
		}
